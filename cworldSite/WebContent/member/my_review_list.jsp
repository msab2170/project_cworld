...
<img src="/cworldSite/img/review_list.png" width="100" height="40"/>
</p>
...
<td><div class="star-ratings" style="display:inline-block;">
	...
	out.println("작성한 리뷰가 없습니다.</td></tr>");
}
%>
</table>
<br />
...
if (rcnt > 0) { 	// 게시글이 있으면 - 페이징 영역을 보여줌
	if (cpage == 1) {
		...
		out.println("<a href='my_review_list?cpage=1'>[처음]</a>&nbsp;&nbsp;&nbsp;<a href='my_review_list?cpage=" + (cpage - 1) + "'>[이전]</a>&nbsp;&nbsp;");
	}
	...
	for (int i = 1, j = spage; i <= bsize && j <= pcnt; i++, j++) {
		...
		if (cpage == j) {
			...
			out.println("&nbsp;<a href='my_review_list?cpage=" + j + schargs + "'>" + j + "</a>");
		}	
	}
	if (cpage == pcnt) {
		out.println("&nbsp;&nbsp;[다음]&nbsp;&nbsp;&nbsp;[마지막]");
	} else {
		out.println("<a href='my_review_list?cpage=" + (cpage + 1) + "'>&nbsp;&nbsp;[다음]</a><a href='my_review_list?cpage=" + pcnt + "'>&nbsp;&nbsp;&nbsp;[마지막]</a>");
	}
}
%>
<br />
